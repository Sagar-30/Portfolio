                    ...
                    <div className="hero-grid">
                        <div className={`hero-content ${isVisible['home'] ? 'fade-in-left' : ''}`}>
                            ...
                            <div className="hero-buttons">
                                ...
                                <a href="https://inspiring-choux-ebe31d.netlify.app/Sagar_Kaushik_Resume.pdf" className="btn-outline" download={true}>
                                    <FiDownload />
                                    <span>Download Resume</span>
                                </a>
                            </div>
                            <div className="social-links">
                                <a href="https://github.com/Sagar-30" className="social-icon"><FiGithub /></a>
                                <a href="https://www.linkedin.com/in/sagar-kaushik-093081205" className="social-icon"><FiLinkedin /></a>
                                <a href="mailto:sagar302001@gmail.com" className="social-icon"><FiMail /></a>
                            </div>
                        </div>
            ...
            <section id="projects" className="projects-section">
                <div className="container">
                    ...
                    <div className="projects-grid">
                        {/* TIS Gifting Website */}
                        <div className={`project-card ${isVisible['projects'] ? 'fade-in-up' : ''}`} o>
                            <div className="project-image">
                                <img src='TIS.png' style={{ width: '100%', height: 'auto', objectFit: 'cover', borderRadius: '8px' }}/>
                                <div className="project-overlay">
                                    <a href="https://www.theindiansanta.com"
                                        target="_blank"
                            ...
                            <div className="project-content">
                                <h3 className="project-title">The Indian Santa - Gifting Website</h3>
                        ...
                        <div className={`project-card ${isVisible['projects'] ? 'fade-in-up' : ''}`} style={{ animationDelay: '200ms' }}>
                            <div className="project-image alt">
                                <img src='Bike_Rental.png' style={{ width: '100%', height: 'auto', objectFit: 'cover', borderRadius: '8px' }}/>
                                <div className="project-overlay">
                                    <a href="https://classy-brioche-53113d.netlify.app/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                    <MdOpenInNew className="project-link-icon" />
                                    ...
                                    {items.map((skill, i) => (
                                        <div key={i} className="skill-item">
                                            <div className="skill-info">
                                                <span>{skill}</span>
                                                {/* <span className="skill-percent">{(i + 1) * 22}%</span> */}
                                            </div>
